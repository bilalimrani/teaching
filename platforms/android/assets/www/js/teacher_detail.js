...
$(document).on('click', '.tDetail', (e)=>{
	...
	document.getElementsByClassName('teacher_sub')[0].innerHTML = "";
	document.getElementsByClassName('teacher_grd')[0].innerHTML = "";
	document.getElementsByClassName('teacher_em')[0].innerHTML = "";
	document.getElementsByClassName('teacher_sch')[0].innerHTML = "";
	document.getElementsByClassName('teacher_n')[0].innerHTML = "";
...
function teacherProfile(res){
	...
	document.getElementsByClassName('teacher_grd')[0].innerHTML = temp
	...
	if(res.response.teacher.email){
		...
		document.getElementsByClassName("teacher_em")[0].className = "lower-caps teacher_em"
	}
	else{
		document.getElementsByClassName("teacher_em")[0].className = "teacher_em"
